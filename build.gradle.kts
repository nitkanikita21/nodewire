...
// ── Control Panel procedural assets ─────────────────────────────────────────
// Item icons / plate texture / item models are generated by tools/GenPanelAssets.java
// (plain java.awt — kept OUT of this script because the Kotlin DSL script
// classpath can't see java.desktop). Output is COMMITTED under
// src/main/resources; re-run after tweaking palette/glyphs.
tasks.register<Exec>("genPanelAssets") {
    group = "nodewire"
    description = "Generate procedural Control Panel textures + item models"
    workingDir = projectDir
    commandLine("java", "tools/GenPanelAssets.java")
}
